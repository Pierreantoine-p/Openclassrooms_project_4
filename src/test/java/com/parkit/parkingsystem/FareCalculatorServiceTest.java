...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void calculateFareBikeWithLessThanHalfHoursFreeParkingTime(){
        Date inTime = new Date();
    ...
    @Test
    public void calculateFareCarWithLessThanHalfHoursFreeParkingTime(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  30 * 60 * 1000) );//45 minutes parking time should give 3/4th parking fare
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE,false);
    ...
    @Test
    public void calculateFareWithReccurentCar(){
        Date inTime = new Date();
    ...
    @Test
    public void calculateFareWithReccurentBike(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  60 * 60 * 1000) );//45 minutes parking time should give 3/4th parking fare
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE,false);
